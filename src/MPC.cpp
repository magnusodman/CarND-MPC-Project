...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  std::cout << "Solution x: " << " delta: " << solution.x[delta_start] << " Acceleration: " << solution.x[a_start] << std::endl;

  std::vector<double> traj_x;
  std::vector<double> traj_y;

  for(int index =x_start; index <y_start; index ++) {
...
vector<double, allocator<double>> MPC::GetTrajectoryX() {
  return this->traj_x;
}

vector<double, allocator<double>> MPC::GetTrajectoryY() {
  return this->traj_y;
}
